...
function StickFooter() {
  ...
  return (
    <>
      <button
        id="add-button"
        className="fixed bg-primary hover:bg-primary-hover w-16 h-16 right-8 bottom-8 rounded-full transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300"
